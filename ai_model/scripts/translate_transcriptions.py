...
# Paths
input_csv = "ai_model/data/processed_data/transcribed_audio.csv"  # Input file
output_csv = "ai_model/data/processed_data/translated_transcriptions.csv"  # Output file

# Load transcriptions
df = pd.read_csv(input_csv)

# Ensure the 'transcription' column exists
...
for idx, text in enumerate(df['transcription']):
    if pd.isna(text) or not text.strip():  # Handle empty transcriptions
        translations.append("")
        continue
